...
JSMpeg.Player = function() {
    ...
    var Player = function(url, options) {
        ...
        if(typeof this.options.canvas === 'string'){
            this.options.canvas = document.querySelector(this.options.canvas)
        }
        this.source = new JSMpeg.Source.Pipe(url, options);
...
JSMpeg.Source.Pipe = function() {
    "use strict";
    var PipeSource = function(url, options) {
        this.options = options;
    ...
    PipeSource.prototype.connect = function() {};
    PipeSource.prototype.destroy = function() {};
    PipeSource.prototype.start = function() {};
    PipeSource.prototype.resume = function() {};
    PipeSource.prototype.onOpen = function() {};
    PipeSource.prototype.onClose = function() {};
    PipeSource.prototype.onMessage = function() {};
    return PipeSource
}();
JSMpeg.Demuxer.TS = function() {
    ...
    TS.prototype.write = function(buffer) {
        ...
        this.packetAddData=TS.prototype.packetAddData
        this.packetComplete=TS.prototype.packetComplete
    ...
    TS.prototype.parsePacket = function() {
        ...
        var streamId = pidsToStreamIds[pid];
        if (payloadStart && streamId) {
            var pi = pesPacketInfo[streamId];
